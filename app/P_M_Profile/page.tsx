                            ...
                            <div className="bg-[#EDF5FF]">
                                <div className="row p-3">
                                    <div className="col-lg-6 col-md-6">
                                        ...
                                        <p className="text-[14px]">Please fill in your valid inputs for General Information</p>
                                    </div>
                                    <div className="col-lg-6 col-md-6">
                                        <div className="d-flex justify-content-start mt-3 mt-md-0 justify-content-md-end">
                                            <button className="btn btnOutlineBlack me-2">Cancel</button>
                                ...
                                <div className="row p-md-3 pb-3 align-items-center ">
                                    ...
                                    <div className="col-lg-3 col-md-4 text-center mt-3 mt-md-0">
                                        <img className="w-full px-3 px-lg-4 mb-3" src="https://play-lh.googleusercontent.com/C9CAt9tZr8SSi4zKCxhQc9v4I6AOTqRmnLchsu1wVDQL0gsQ3fmbCVgQmOVM1zPru8UH=w240-h480-rw" />
