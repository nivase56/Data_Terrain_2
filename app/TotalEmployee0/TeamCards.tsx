      ...
      <div className="border rounded px-2">
        ...
        <div className="row py-2">
          <div className="col-6 py-3 text-center border-end">
            <h1 className='text-blue Poppins-SemiBold text-[36px]'>{data.number1}</h1>
            <h6  className='text-[16px]'>{data.label1}</h6>
          </div>
          <div className="col-6 py-3 text-center">
            <h1 className='text-dark Poppins-SemiBold text-[36px]'>{data.number2}</h1>
