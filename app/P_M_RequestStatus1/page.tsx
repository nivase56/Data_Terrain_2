                                        ...
                                        <div className='mt-5'>
                                            <Box className="requesttableTabs" sx={{ width: '100%' }}>
                                                <div className='row border-b'>
                                                    <div className='col-lg-3 order-lg-last text-right'>
                                                        <button className=" btn btn-blue btn-sm text-[14px!important]  ms-2" onClick={modalareYouSure}>Approve</button>
                                                        <button className="btn btnOutlineblue btn-sm text-[14px!important]  ms-2">Reject</button>
                                                        <button className="btn btn-white btn-sm ms-2 text-red-500 px-1 hover:bg-white p-0">
                                                            <i className="fa fa-trash fs-5 text-red-500" aria-hidden="true"></i>
                                                        </button>
                                                    </div>
                                                    <div className='col-lg-9'>
                                                        <Box>
                                            ...
                                            <div>
                                                <div className='text-center'>
                                                    <button className="btn btnOutlineBlack mx-1" onClick={(e) => e.stopPropagation()}>Previous Page</button>
                                                    <button className="btn btn-blue mx-1" onClick={(e) => e.stopPropagation()}>Next Page</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                >
                    <Box className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:w-[700px] w-[400px] bg-white border-1 border-blue-500 shadow-lg p-4">
                        <div className="flex justify-between items-center border-bottom mb-4 pb-3">
                            ...
                            <button onClick={handleCloseAreYouSure} className="btn btn-blue w-[30px] h-[30px!important] !rounded-[50%] p-0 align-items-center justify-content-center">
                                <i className="fa fa-close"></i>
                            </button>
                        </div>

                        <div className='py-4'>
                            <Typography className='text-center text-[20px]' id="modal-modal-title" variant="h6" component="h2">
                                Move to Job Description
                            </Typography>
                            <Typography className='mt-3' id="modal-modal-description" sx={{ mt: 2 }}>
                                <div className="text-center">
                                    <button className="btn btnOutlineBlack mx-2">NO</button>
                                    <button className="btn btn-blue mx-2">YES</button>
                                </div>
                            </Typography>
                        </div>
                    </Box>
