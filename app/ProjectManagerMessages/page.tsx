                                    ...
                                    <div className="col-lg-7 flex mt-4">
                                        <div className="shadow w-100 pb-[80px] position-relative ">
                                            <div className="row mx-0 py-2 mb-2 min-h-100 border-bottom align-items-center">
                                                <div className="col-lg-2 col-3 ps-2 pe-0">
                                                    <img className="w-[50px] rounded-full h-[50px]" src="https://images.ctfassets.net/h6goo9gw1hh6/2sNZtFAWOdP1lmQ33VwRN3/24e953b920a9cd0ff2e1d587742a2472/1-intro-photo-final.jpg?w=1200&h=992&fl=progressive&q=70&fm=jpg" alt="" />
                                                </div>
                                                <div className="col-lg-7 col-6">
                                                    <h6 className='text-[15px]'>Angela</h6>
                                                    <p className='text-[12px] text-[#4BAF1C]'><i className="fa fa-circle text-[10px]" aria-hidden="true"></i> Online</p>
                                                </div>
                                                <div className="col-lg-3 col-3 pe-2 ps-0 text-end">
                                                    <Link href="#"><i className="fa fa-ellipsis-v" aria-hidden="true"></i></Link>
                                                </div>
                                            </div>
                                            ...
                                            <div className="position-absolute bottom-0 right-0 left-0">
                                                ...
                                                <i className="fa fa-share position-absolute bottom-[20px] right-[20px]" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
