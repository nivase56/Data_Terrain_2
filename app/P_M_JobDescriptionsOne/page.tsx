...
function ProjectManagerJobDescriptions(params: type) {
    ...
    const dataArray = [
        { id: '#py001', imagePath: 'image/editIcon.png', description: 'Senior Python Developers' },
        { id: '#py002', imagePath: 'image/editIcon.png', description: 'Junior Python Developers' },
        { id: '#py003', imagePath: 'image/editIcon.png', description: 'Python Engineers' },
        { id: '#py001', imagePath: 'image/editIcon.png', description: 'Senior Python Developers' },
                                ...
                                <div className="shadow bg-white mt-4 rounded-3 pb-3">
                                    ...
                                    <div className='shadow mx-3 mb-4 mt-4 p-3'>
                                        <div className="d-flex">
                                            <img className='h-[22px] w-[22px]' src="image/python.png" alt="" />
                                            <h5 className='Poppins-Regular ms-2'>python developer [325 JD`s]</h5>
                                        </div>
                                            ...
                                            {dataArray.map((dataItem, index) => (
                                                <div key={index} className="col-lg-3 mt-3 px-2">
                                                    <div className="border p-2 hover:shadow-lg">
                                                        ...
                                                        <p className='py-3 text-[13px]'>{dataItem.description}</p>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
                                    ...
                                    <div className='shadow mx-3 mb-4 mt-4 p-3'>
                                        <div className="d-flex">
                                            <img className='h-[22px] w-[22px]' src="image/java.png" alt="" />
                                            <h5 className='Poppins-Regular ms-2'>Java Developers [ 325 JD’s]</h5>
                                        </div>
                                    ...
                                    <div className='shadow mx-3 mb-4 mt-4 p-3'>
                                        <div className="d-flex">
                                            <img className='h-[22px] w-[22px]' src="image/Angularicon.png" alt="" />
                                            <h5 className='Poppins-Regular ms-2'>Angular Developers [ 325 JD’s]</h5>
                                        </div>
