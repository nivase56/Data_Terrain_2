    ...
    return (
        <div className="row mt-4 align-items-center ">
            ...
            <div className="col-3 text-end">
                <button className="btn btnOutlineblue btn-sm text-[13px!important]">Details</button>
            </div>
        </div>
    );
}
    ...
    const appointments = [
        {
            ...
            creator: 'Stella',
            position: 'Senior Python Develpper',
            profileImg: 'https://a.storyblok.com/f/191576/1200x800/faa88c639f/round_profil_picture_before_.webp'
            ...
            creator: 'Stella',
            position: 'Senior Python Develpper',
            profileImg: 'https://t4.ftcdn.net/jpg/04/44/53/99/360_F_444539901_2GSnvmTX14LELJ6edPudUsarbcytOEgj.jpg'
