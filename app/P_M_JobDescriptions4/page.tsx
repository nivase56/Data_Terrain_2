...
const JobDescription = ({ key, title,smallTitle }) => {
    return (
        <div key={key} className='col-lg-4 mt-3 px-1'>
            <div className='border border-color-[red] bg-[#fff] hover:bg-blue-100 p-2'>
                ...
                <p className='text-[10px] mt-2 Poppins-Light leading-[13px]'>{smallTitle}</p>
            </div>
        </div>
    );
};
...
function P_M_JobDescriptionsFour(params: type) {
    ...
    const jobDescriptionsData = [
        { key: 1, title: 'Python developer job descriptions', smallTitle:'Please add Django, next.js and html, css' },
        { key: 2, title: 'Python developer job descriptions',smallTitle:'Please add Django, next.js and html, css'  },
        { key: 3, title: 'Python developer job descriptions',smallTitle:'Please add Django, next.js and html, css'  },
        { key: 4, title: 'Python developer job descriptions',smallTitle:'Please add Django, next.js and html, css' },
        { key: 5, title: 'Python developer job descriptions',smallTitle:'Please add Django, next.js and html, css' },
        { key: 6, title: 'Python developer job descriptions',smallTitle:'Please add Django, next.js and html, css' },
    ];
                        ...
                        <div className="row">
                            <div className="col-lg-9">
                                <div className="shadow bg-white mt-4 rounded-3 pb-3">
                                    <PostedJobsTop titleName="Job Descriptions Assets" classTitle="text-[20px] Poppins-Regular" samllText="History"
                                        filterBtnClass="d-none"
                                    />
                                    ...
                                    <div className='row mt-3'>
                                        ...
                                        <div className='col-lg-9'>
                                            <div className='bg-[#F9F9F9] p-3 mx-3'>
                                                ...
                                                <h5 className='text-center'>Welcome Talent Acquisition board chatbot</h5>
                                                <div className='md:mt-[100px] mt-[50px] text-center'>
                                                    <img src="image/chatBot.png" alt="" />
                                                </div>
                                                <h5 className='text-center mt-2'>Which types of job description need?</h5>
